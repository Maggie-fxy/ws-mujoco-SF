...
class SolefootController:
    ...
    def initialize_onnx_models(self):
        ...
        # for output_meta in self.policy_session.get_outputs():
        ...
        # for input_meta in self.encoder_session.get_inputs():
        #     print(f"Encoder Input name: {input_meta.name}")
        #     print(f"Encoder Input shape: {input_meta.shape}")

        # for output_meta in self.encoder_session.get_outputs():
        #     print(f"Encoder Output name: {output_meta.name}")
        #     print(f"Encoder Output shape: {output_meta.shape}")
    ...
    def compute_observation(self):
        ...
        print(f"Shape of obs before clipping: {obs.shape}")
        print(f"Shape of self.observations after clipping: {self.observations.shape}")
    def compute_actions(self):
        ...
        print(f"Encoder Output (self.encoder_out) shape: {self.encoder_out.shape}")
        # print(f"Encoder Output (self.encoder_out): {self.encoder_out}")
        
        print(f"Observations (self.observations) shape: {self.observations.shape}")
        # print(f"Observations (self.observations): {self.observations}")
        
        print(f"Scaled Commands (self.scaled_commands) shape: {self.scaled_commands.shape}")
        # print(f"Scaled Commands (self.scaled_commands): {self.scaled_commands}")
